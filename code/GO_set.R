...
findGO <- function(pattern, method = "key", ont = 'ALL'){
  ...
  if(ont == 'BP'){
    pathways <- cbind(pathways[rownames(pathways) %in% names(GO_DATA$GO2ONT[GO_DATA$GO2ONT == 'BP']),])
  }else if(ont == 'MF'){
    pathways <- cbind(pathways[rownames(pathways) %in% names(GO_DATA$GO2ONT[GO_DATA$GO2ONT == 'MF']),])
  }else if(ont == 'CC'){
    pathways <- cbind(pathways[rownames(pathways) %in% names(GO_DATA$GO2ONT[GO_DATA$GO2ONT == 'CC']),])
  }
